...
namespace MF.ERP.DataAccess.Migrations
{
    ...
    [Migration("20240528222925_initNew0")]
    partial class initNew0
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MF.ERP.Models.ActionsDetails", b =>
                {
                    ...
                    b.Property<int>("ActionsMasterId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("LocationWhenWithCustomer")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool?>("isConsumeRecorded")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("MF.ERP.Models.ActionsMaster", b =>
                {
                    ...
                    b.ToTable("ActionsMaster", (string)null);
                });
            ...
            modelBuilder.Entity("MF.ERP.Models.ActionsDetails", b =>
                {
                    ...
                    b.HasOne("MF.ERP.Models.ActionsMaster", "ActionsMaster")
                        .WithMany("Details")
                        .HasForeignKey("ActionsMasterId")
