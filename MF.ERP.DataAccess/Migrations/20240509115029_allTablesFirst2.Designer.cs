...
namespace MF.ERP.DataAccess.Migrations
{
    ...
    [Migration("20240509115029_allTablesFirst2")]
    partial class allTablesFirst2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MF.ERP.Models.Team", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TartgetTypeId1");

                    b.ToTable("Teams");
                });

            modelBuilder.Entity("MF.ERP.Models.TeamArea", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MF.ERP.Models.TeamTarget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MF.ERP.Models.Customer", b =>
                {
                    ...
                    b.HasOne("MF.ERP.Models.Status", "LastStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("MF.ERP.Models.Team", b =>
                {
                    b.HasOne("MF.ERP.Models.TeamTarget", "TartgetType")
                        .WithMany()
                        .HasForeignKey("TartgetTypeId1");
            ...
            modelBuilder.Entity("MF.ERP.Models.TeamArea", b =>
                {
                    ...
                    b.HasOne("MF.ERP.Models.Team", "Team")
                        .WithMany("TeamAreas")
